<template>
    <main class="min-h-screen bg-gray-950 text-white flex flex-col items-center justify-center px-6 py-12">
        ...
        <img src="../assets/bitcraft_monogram_transparent...PNG" alt="BitPulse Logo" class="h-24 mb-6 z-10" />
        ...
        <section class="text-center max-w-3xl">
            ...
            <div class="flex gap-4 justify-center">
                ...
                <a href="https://github.com/aine-dickson/bitcraft" target="_blank" class="border border-orange-400 text-orange-400 hover:bg-orange-500 hover:text-white py-2 px-4 rounded-xl transition">
                    Follow on GitHub
                </a>
            </div>
        </section>
      ...
      <section id="coming" class="mt-24 max-w-4xl text-center">
        ...
        <footer class="mt-24 text-gray-500 text-sm">
            Made with ❤️ by BitPulse · <a href="https://bitpulse.dev" class="underline hover:text-white">bitpulse.dev</a>
        </footer>
    </main>
</template>
